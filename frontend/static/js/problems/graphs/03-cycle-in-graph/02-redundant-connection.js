...
func main() {
    ...
    fmt.Println(findRedundantConnection(edges2)) // Output: [1 4]
        ...
        twists: [
            { id: '03-cycle-in-graph/02-redundant-connection/twist-01-redundant-connection-in-a-directed-graph', name: 'Redundant Connection in a Directed Graph', difficulty: 'Hard' },
            { id: '03-cycle-in-graph/02-redundant-connection/twist-02-remove-edge-using-dfs-instead-of-union-find', name: 'Remove Edge Using DFS Instead of Union-Find', difficulty: 'Medium' },
            { id: '03-cycle-in-graph/02-redundant-connection/twist-03-remove-minimum-weight-edge-to-break-all-cycles', name: 'Remove Minimum Weight Edge to Break All Cycles', difficulty: 'Hard' },
            { id: '03-cycle-in-graph/02-redundant-connection/twist-04-find-the-last-redundant-edge', name: 'Find the Last Redundant Edge', difficulty: 'Medium' },
            { id: '03-cycle-in-graph/02-redundant-connection/twist-05-redundant-connection-with-disconnected-components', name: 'Redundant Connection with Disconnected Components', difficulty: 'Medium' }
        ],
        similar: [

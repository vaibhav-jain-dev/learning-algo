...
func main() {
    ...
    fmt.Println(HasNegativeCycle(3, edges3)) // false
        ...
        twists: [
            { id: '11-detect-arbitrage/03-negative-cycle-detection/twist-01-find-the-negative-cycle', name: 'Find the Negative Cycle', difficulty: 'Hard' },
            { id: '11-detect-arbitrage/03-negative-cycle-detection/twist-02-positive-cycle-detection', name: 'Positive Cycle Detection', difficulty: 'Easy' },
            { id: '11-detect-arbitrage/03-negative-cycle-detection/twist-03-shortest-path-with-no-negative-cycles', name: 'Shortest Path with No Negative Cycles', difficulty: 'Medium' },
            { id: '11-detect-arbitrage/03-negative-cycle-detection/twist-04-minimum-weight-cycle', name: 'Minimum Weight Cycle', difficulty: 'Very Hard' },
            { id: '11-detect-arbitrage/03-negative-cycle-detection/twist-05-negative-cycle-in-undirected-graph', name: 'Negative Cycle in Undirected Graph', difficulty: 'Hard' }
        ],
        similar: [

...
(function() {
        ...
        examples: [
    {
        ...
        twists: [
            { id: '02-breadth-first-search/twist-01-bfs-with-level-tracking', name: 'BFS with Level Tracking', difficulty: 'Easy' },
            { id: '02-breadth-first-search/twist-02-bfs-on-a-directed-graph-with-unreachable-nodes', name: 'BFS on a Directed Graph with Unreachable Nodes', difficulty: 'Medium' },
            { id: '02-breadth-first-search/twist-03-bidirectional-bfs', name: 'Bidirectional BFS', difficulty: 'Hard' },
            { id: '02-breadth-first-search/twist-04-bfs-on-adjacency-matrix', name: 'BFS on Adjacency Matrix', difficulty: 'Medium' },
            { id: '02-breadth-first-search/twist-05-dfs-vs-bfs-comparison', name: 'DFS vs BFS Comparison', difficulty: 'Medium' }
        ],
        similar: [

...
func main() {
    ...
    fmt.Println(maxAreaOfIsland(grid2)) // 4
        ...
        twists: [
            { id: '05-river-sizes/01-max-area-of-island/twist-01-count-all-islands', name: 'Count All Islands', difficulty: 'Easy' },
            { id: '05-river-sizes/01-max-area-of-island/twist-02-top-k-island-areas', name: 'Top K Island Areas', difficulty: 'Medium' },
            { id: '05-river-sizes/01-max-area-of-island/twist-03-island-shapes-as-signatures', name: 'Island Shapes as Signatures', difficulty: 'Hard' },
            { id: '05-river-sizes/01-max-area-of-island/twist-04-max-area-with-diagonal-connections', name: 'Max Area with Diagonal Connections', difficulty: 'Medium' },
            { id: '05-river-sizes/01-max-area-of-island/twist-05-iterative-dfs-only', name: 'Iterative DFS Only', difficulty: 'Medium' }
        ],
        similar: []
    };

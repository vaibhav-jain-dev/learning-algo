...
func main() {
    ...
    fmt.Println(result) // Expected: [1, 0, -1]
        ...
        twists: [
            { id: '04-youngest-common-ancestor/02-kth-ancestor-of-tree-node/twist-01-kth-ancestor-without-preprocessing', name: 'Kth Ancestor Without Preprocessing', difficulty: 'Easy' },
            { id: '04-youngest-common-ancestor/02-kth-ancestor-of-tree-node/twist-02-lca-via-kth-ancestor', name: 'LCA via Kth Ancestor', difficulty: 'Hard' },
            { id: '04-youngest-common-ancestor/02-kth-ancestor-of-tree-node/twist-03-dynamic-tree-with-insertions', name: 'Dynamic Tree with Insertions', difficulty: 'Very Hard' },
            { id: '04-youngest-common-ancestor/02-kth-ancestor-of-tree-node/twist-04-path-between-two-nodes', name: 'Path Between Two Nodes', difficulty: 'Medium' },
            { id: '04-youngest-common-ancestor/02-kth-ancestor-of-tree-node/twist-05-ancestor-at-given-depth', name: 'Ancestor at Given Depth', difficulty: 'Medium' }
        ],
        similar: [

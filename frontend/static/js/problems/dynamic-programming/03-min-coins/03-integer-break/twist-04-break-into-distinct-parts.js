    ...
    const problem = {
        ...
        examples: [
            // Basic test case
            {
                input: {"n":2},
                output: 1,
                explanation: 'For this input, there is 1 valid position that satisfy the break into distinct parts criteria.'
            },
            {
                input: {"n":10},
                output: 2,
                explanation: 'For this input, there are 2 valid positions that satisfy the break into distinct parts criteria.'
            },
            {
                input: {"n":8},
                output: 0,
                explanation: 'For this input, there are 0 valid positions that satisfy the break into distinct parts criteria.'
            },
            // Edge case
            {
                input: {"n":0},

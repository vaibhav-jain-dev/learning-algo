    ...
    const problem = {
        ...
        examples: [
            // Basic test case
            {
                input: {"n":12},
                output: 1,
                explanation: 'For this input, there is 1 valid position that satisfy the print which squares were used criteria.'
            },
            {
                input: {"n":13},
                output: 2,
                explanation: 'For this input, there are 2 valid positions that satisfy the print which squares were used criteria.'
            },
            // Edge case
            {
                input: {"n":0},

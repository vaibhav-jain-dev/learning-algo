...
(function() {
    ...
    },
    {
        ...
        twists: [
            { id: '10-max-profit-k-transactions/twist-01-unlimited-transactions', title: 'Unlimited Transactions', difficulty: 'Medium' },
            { id: '10-max-profit-k-transactions/twist-02-transactions-with-cooldown', title: 'Transactions With Cooldown', difficulty: 'Hard' },
            { id: '10-max-profit-k-transactions/twist-03-transactions-with-fee', title: 'Transactions With Fee', difficulty: 'Medium' },
            { id: '10-max-profit-k-transactions/twist-04-find-optimal-buy-sell-days', title: 'Find Optimal Buy-Sell Days', difficulty: 'Medium' },
            { id: '10-max-profit-k-transactions/twist-05-minimum-transactions-for-target-profit', title: 'Minimum Transactions for Target Profit', difficulty: 'Hard' }
        ],
        similar: [

...
(function() {
    ...
    },
    {
        ...
        twists: [
            { id: '14-longest-string-chain/twist-01-string-chain-with-deletion', title: 'String Chain With Deletion', difficulty: 'Medium' },
            { id: '14-longest-string-chain/twist-02-longest-chain-with-any-edit', title: 'Longest Chain With Any Edit', difficulty: 'Hard' },
            { id: '14-longest-string-chain/twist-03-count-longest-string-chains', title: 'Count Longest String Chains', difficulty: 'Medium' },
            { id: '14-longest-string-chain/twist-04-string-chain-forming-target', title: 'String Chain Forming Target', difficulty: 'Hard' },
            { id: '14-longest-string-chain/twist-05-minimum-words-to-bridge', title: 'Minimum Words to Bridge', difficulty: 'Hard' }
        ],
        similar: [

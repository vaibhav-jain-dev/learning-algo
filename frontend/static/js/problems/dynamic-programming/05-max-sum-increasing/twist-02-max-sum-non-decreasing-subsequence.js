    ...
    const problem = {
        ...
        examples: [
            // Basic test case
            {
                ...
                output: 2,
                explanation: 'For this input, there are 2 valid positions that satisfy the max sum non decreasing subsequence criteria.'
            },
            {
                input: {"array":[8,12,2,3,15,5,7]},
                output: 3,
                explanation: 'For this input, there are 3 valid positions that satisfy the max sum non decreasing subsequence criteria.'
            },
            {
                input: {"array":[1,2,3,4,5]},
                output: 1,
                explanation: 'For this input, there is 1 valid position that satisfy the max sum non decreasing subsequence criteria.'
            },
            // Edge case
            {
                input: {"array":[10]},

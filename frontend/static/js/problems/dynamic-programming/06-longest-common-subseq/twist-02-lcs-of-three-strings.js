    ...
    const problem = {
        ...
        examples: [
            // Basic test case
            {
                ...
                output: 1,
                explanation: 'For this input, there is 1 valid position that satisfy the lcs of three strings criteria.'
            },
            {
                input: {"str1":"ABCDGH","str2":"AEDFHR"},
                output: 2,
                explanation: 'For this input, there are 2 valid positions that satisfy the lcs of three strings criteria.'
            },
            {
                input: {"str1":"ABC","str2":"DEF"},
                output: 0,
                explanation: 'For this input, there are 0 valid positions that satisfy the lcs of three strings criteria.'
            },
            // Edge case
            {
                input: {"str1":"","str2":""},

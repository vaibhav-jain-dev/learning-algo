    ...
    const problem = {
        ...
        examples: [
            // Basic test case
            {
                ...
                output: 1,
                explanation: 'For this input, there is 1 valid position that satisfy the can reach end boolean criteria.'
            },
            {
                input: {"array":[2,1,1]},
                output: 2,
                explanation: 'For this input, there are 2 valid positions that satisfy the can reach end boolean criteria.'
            },
            {
                input: {"array":[1,1,1,1]},
                output: 0,
                explanation: 'For this input, there are 0 valid positions that satisfy the can reach end boolean criteria.'
            },
            {
                input: {"array":[1,0,1]},
                output: 3,
                explanation: 'For this input, there are 3 valid positions that satisfy the can reach end boolean criteria.'
            },
            // Edge case
            {
                input: {"array":[3]},

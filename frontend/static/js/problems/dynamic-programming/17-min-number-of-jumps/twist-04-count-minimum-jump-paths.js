...
(function() {
    ...
    const problem = {
        ...
        algorithm: 'dp-jumps',
        parent: '17-min-number-of-jumps',
        description: 'Find how many distinct paths achieve the minimum number of jumps to reach the last index.',
        problem: 'Combines the minimum-jumps optimization with counting. You need to track both the minimum jumps to each position and the number of ways to achieve that minimum.',
        hints: [
            'Start with the base problem solution and identify what assumption changes for this twist.',
            'Key difference from the base problem: Combines the minimum-jumps optimization with counting. You need to track both the minimum jumps to each position and the',

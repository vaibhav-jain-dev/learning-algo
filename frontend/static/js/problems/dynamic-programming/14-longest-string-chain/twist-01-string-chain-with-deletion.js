    ...
    const problem = {
        ...
        examples: [
            // Basic test case
            {
                ...
                output: 2,
                explanation: 'For this input, there are 2 valid positions that satisfy the string chain with deletion criteria.'
            },
            {
                input: {"words":["xbc","pcxbcf","xb","cxbc","pcxbc"]},
                output: 3,
                explanation: 'For this input, there are 3 valid positions that satisfy the string chain with deletion criteria.'
            },
            {
                input: {"words":["abcd","dbqca"]},
                output: 1,
                explanation: 'For this input, there is 1 valid position that satisfy the string chain with deletion criteria.'
            },
            // Edge case
            {
                input: {"words":["a"]},

    ...
    const problem = {
        ...
        examples: [
            // Basic test case
            {
                ...
                output: 1,
                explanation: 'For this input, there is 1 valid position that satisfy the conceptual trap handling zeros in the array criteria.'
            },
            {
                input: {"nums":[1],"target":1},
                output: 0,
                explanation: 'For this input, there are 0 valid positions that satisfy the conceptual trap handling zeros in the array criteria.'
            },
            // Edge case
            {

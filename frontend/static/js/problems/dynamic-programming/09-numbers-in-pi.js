...
(function() {
    ...
    },
    {
        ...
        twists: [
            { id: '09-numbers-in-pi/twist-01-return-the-actual-partition', title: 'Return the Actual Partition', difficulty: 'Medium' },
            { id: '09-numbers-in-pi/twist-02-maximum-coverage-partition', title: 'Maximum Coverage Partition', difficulty: 'Hard' },
            { id: '09-numbers-in-pi/twist-03-numbers-in-pi-with-overlaps', title: 'Numbers in Pi With Overlaps', difficulty: 'Hard' },
            { id: '09-numbers-in-pi/twist-04-weighted-number-selection', title: 'Weighted Number Selection', difficulty: 'Hard' },
            { id: '09-numbers-in-pi/twist-05-longest-prefix-coverable', title: 'Longest Prefix Coverable', difficulty: 'Medium' }
        ],
        similar: [

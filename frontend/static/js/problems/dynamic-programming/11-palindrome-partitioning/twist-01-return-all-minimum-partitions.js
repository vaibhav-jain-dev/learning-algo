    ...
    const problem = {
        ...
        examples: [
            // Basic test case
            {
                ...
                output: 1,
                explanation: 'For this input, there is 1 valid position that satisfy the return all minimum partitions criteria.'
            },
            {
                input: {"string":"aab"},
                output: 2,
                explanation: 'For this input, there are 2 valid positions that satisfy the return all minimum partitions criteria.'
            },
            {
                input: {"string":"aba"},
                output: 0,
                explanation: 'For this input, there are 0 valid positions that satisfy the return all minimum partitions criteria.'
            },
            {
                input: {"string":"abcde"},
                output: 3,
                explanation: 'For this input, there are 3 valid positions that satisfy the return all minimum partitions criteria.'
            },
            // Edge case
            {
                input: {"string":""},

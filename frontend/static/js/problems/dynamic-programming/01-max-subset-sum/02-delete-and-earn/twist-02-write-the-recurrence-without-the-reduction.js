    ...
    const problem = {
        ...
        examples: [
            // Basic test case
            {
                input: {"nums":[3,4,2]},
                output: 1,
                explanation: 'For this input, there is 1 valid position that satisfy the write the recurrence without the reduction criteria.'
            },
            {
                input: {"nums":[2,2,3,3,3,4]},
                output: 2,
                explanation: 'For this input, there are 2 valid positions that satisfy the write the recurrence without the reduction criteria.'
            },
            // Edge case
            {
                input: {"nums":[3]},
        ...
        solutions: {
            python: `def write_the_recurrence_without_the_reduction(nums):
    """
    Write the Recurrence Without the Reduction
...
# Test cases
print(write_the_recurrence_without_the_reduction([3,4,2]))  # Expected: 1
print(write_the_recurrence_without_the_reduction([2,2,3,3,3,4]))  # Expected: 2
print(write_the_recurrence_without_the_reduction([3]))  # Expected: 0
`,
            go: `package main
...
func WriteTheRecurrenceWithoutTheReduction(nums []int) int {
	result := 0
...
func main() {
	fmt.Println(WriteTheRecurrenceWithoutTheReduction([]int{3, 4, 2})) // Expected: 1
	fmt.Println(WriteTheRecurrenceWithoutTheReduction([]int{2, 2, 3, 3, 3, 4})) // Expected: 2
	fmt.Println(WriteTheRecurrenceWithoutTheReduction([]int{3})) // Expected: 0
}
`
        },
        twists: [],

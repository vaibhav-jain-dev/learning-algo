...
func main() {
    ...
    fmt.Println(minWindow("abcdef", "ace"))                        // "abcde"
        ...
        twists: [
            { id: '01-validate-subsequence/03-minimum-window-subsequence/twist-01-all-minimum-windows', name: 'All Minimum Windows', difficulty: 'Hard' },
            { id: '01-validate-subsequence/03-minimum-window-subsequence/twist-02-minimum-window-with-character-order-relaxed', name: 'Minimum Window with Character Order Relaxed', difficulty: 'Medium' },
            { id: '01-validate-subsequence/03-minimum-window-subsequence/twist-03-minimum-window-subsequence-in-circular-string', name: 'Minimum Window Subsequence in Circular String', difficulty: 'Very Hard' },
            { id: '01-validate-subsequence/03-minimum-window-subsequence/twist-04-k-shortest-window-subsequences', name: 'K Shortest Window Subsequences', difficulty: 'Hard' },
            { id: '01-validate-subsequence/03-minimum-window-subsequence/twist-05-minimum-window-subsequence-with-wildcards', name: 'Minimum Window Subsequence with Wildcards', difficulty: 'Hard' }
        ],
        similar: []
    };

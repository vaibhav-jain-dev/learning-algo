    ...
    const problem = {
        ...
        examples: [
            // Basic test case
            {
                ...
                output: 1,
                explanation: 'For this input, there is 1 valid position that satisfy the first duplicate without mutation criteria.'
            },
            {
                input: {"array":[2,1,5,3,3,2,4]},
                output: 2,
                explanation: 'For this input, there are 2 valid positions that satisfy the first duplicate without mutation criteria.'
            },
            {
                input: {"array":[1,2,3,4,5]},
                output: 0,
                explanation: 'For this input, there are 0 valid positions that satisfy the first duplicate without mutation criteria.'
            },
            {
                input: {"array":[1,1,2,3,3,2,2]},
                output: 3,
                explanation: 'For this input, there are 3 valid positions that satisfy the first duplicate without mutation criteria.'
            },
            // Edge case
            {
                input: {"array":[2]},

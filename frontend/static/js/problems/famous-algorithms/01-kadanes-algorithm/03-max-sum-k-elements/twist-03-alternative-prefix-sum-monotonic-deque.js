    ...
    const problem = {
        ...
        examples: [
            // Basic test case
            {
                ...
                output: 1,
                explanation: 'For this input, there is 1 valid position that satisfy the alternative prefix sum monotonic deque criteria.'
            },
            {
                input: {"nums":[-1,-2,-3],"k":2},
                output: 2,
                explanation: 'For this input, there are 2 valid positions that satisfy the alternative prefix sum monotonic deque criteria.'
            },
            // Edge case
            {
                input: {"nums":[1],"k":0},

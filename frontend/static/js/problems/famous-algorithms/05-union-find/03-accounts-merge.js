...
func main() {
    ...
    fmt.Println(AccountsMerge(accounts))
        ...
        twists: [
            { id: '05-union-find/03-accounts-merge/twist-01-dfs-bfs-graph-approach', name: 'DFS/BFS Graph Approach', difficulty: 'Medium' },
            { id: '05-union-find/03-accounts-merge/twist-02-accounts-with-conflicts', name: 'Accounts with Conflicts', difficulty: 'Hard' },
            { id: '05-union-find/03-accounts-merge/twist-03-incremental-account-merge', name: 'Incremental Account Merge', difficulty: 'Hard' },
            { id: '05-union-find/03-accounts-merge/twist-04-find-duplicate-accounts-only', name: 'Find Duplicate Accounts Only', difficulty: 'Easy' },
            { id: '05-union-find/03-accounts-merge/twist-05-account-merge-with-phone-numbers', name: 'Account Merge with Phone Numbers', difficulty: 'Medium' }
        ],
        similar: [

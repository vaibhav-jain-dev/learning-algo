...
(function() {
        ...
        examples: [
    {
        ...
        twists: [
            { id: '01-kadanes-algorithm/twist-01-proof-of-correctness', name: 'Proof of Correctness', difficulty: 'Hard' },
            { id: '01-kadanes-algorithm/twist-02-when-does-greedy-fail', name: 'When Does Greedy Fail?', difficulty: 'Medium' },
            { id: '01-kadanes-algorithm/twist-03-alternative-data-structure-approach', name: 'Alternative Data Structure Approach', difficulty: 'Medium' },
            { id: '01-kadanes-algorithm/twist-04-online-streaming-variant', name: 'Online Streaming Variant', difficulty: 'Hard' },
            { id: '01-kadanes-algorithm/twist-05-space-time-tradeoff-return-the-subarray', name: 'Space-Time Tradeoff: Return the Subarray', difficulty: 'Medium' },
            { id: '01-kadanes-algorithm/twist-06-conceptual-trap-all-negatives', name: 'Conceptual Trap: All Negatives', difficulty: 'Easy' }
        ],
        similar: [

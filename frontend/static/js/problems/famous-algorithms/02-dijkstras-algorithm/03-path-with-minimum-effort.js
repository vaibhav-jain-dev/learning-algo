...
func main() {
    ...
    fmt.Println(MinimumEffortPath(heights)) // Output: 2
        ...
        twists: [
            { id: '02-dijkstras-algorithm/03-path-with-minimum-effort/twist-01-alternative-binary-search-bfs', name: 'Alternative: Binary Search + BFS', difficulty: 'Medium' },
            { id: '02-dijkstras-algorithm/03-path-with-minimum-effort/twist-02-alternative-union-find-approach', name: 'Alternative: Union-Find Approach', difficulty: 'Hard' },
            { id: '02-dijkstras-algorithm/03-path-with-minimum-effort/twist-03-proof-why-dijkstra-works-with-max-instead-of-sum', name: 'Proof: Why Dijkstra Works With Max Instead of Sum', difficulty: 'Hard' },
            { id: '02-dijkstras-algorithm/03-path-with-minimum-effort/twist-04-conceptual-trap-diagonal-movement', name: 'Conceptual Trap: Diagonal Movement', difficulty: 'Medium' },
            { id: '02-dijkstras-algorithm/03-path-with-minimum-effort/twist-05-parallel-version-wavefront-processing', name: 'Parallel Version: Wavefront Processing', difficulty: 'Very Hard' },
            { id: '02-dijkstras-algorithm/03-path-with-minimum-effort/twist-06-space-time-tradeoff-a-enhancement', name: 'Space-Time Tradeoff: A* Enhancement', difficulty: 'Hard' }
        ],
        similar: [

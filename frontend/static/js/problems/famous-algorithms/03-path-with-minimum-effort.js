...
(function() {
    ...
    if (window.ProblemRenderer) {
        window.ProblemRenderer.register('famous-algorithms', '03-path-with-minimum-effort', problem);
    }

    // Export for direct access
    window.Problems = window.Problems || {};
    window.Problems['famous-algorithms/03-path-with-minimum-effort'] = problem;

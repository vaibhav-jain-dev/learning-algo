...
func main() {
    ...
    fmt.Println(WordLadderWithHeuristic(data)) // 5
        ...
        twists: [
            { id: '08-a-star-algorithm/03-word-ladder-heuristic/twist-01-all-shortest-paths', name: 'All Shortest Paths', difficulty: 'Hard' },
            { id: '08-a-star-algorithm/03-word-ladder-heuristic/twist-02-bidirectional-bfs', name: 'Bidirectional BFS', difficulty: 'Hard' },
            { id: '08-a-star-algorithm/03-word-ladder-heuristic/twist-03-weighted-transformations', name: 'Weighted Transformations', difficulty: 'Hard' },
            { id: '08-a-star-algorithm/03-word-ladder-heuristic/twist-04-maximum-ladder-length', name: 'Maximum Ladder Length', difficulty: 'Medium' },
            { id: '08-a-star-algorithm/03-word-ladder-heuristic/twist-05-edit-distance-heuristic-analysis', name: 'Edit Distance Heuristic Analysis', difficulty: 'Medium' }
        ],
        similar: [

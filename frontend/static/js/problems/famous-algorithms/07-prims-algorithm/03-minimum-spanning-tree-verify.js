...
func main() {
    ...
    fmt.Println(MinimumSpanningTreeVerification(data)) // true
        ...
        twists: [
            { id: '07-prims-algorithm/03-minimum-spanning-tree-verify/twist-01-verify-using-cut-property', name: 'Verify Using Cut Property', difficulty: 'Hard' },
            { id: '07-prims-algorithm/03-minimum-spanning-tree-verify/twist-02-verify-using-cycle-property', name: 'Verify Using Cycle Property', difficulty: 'Hard' },
            { id: '07-prims-algorithm/03-minimum-spanning-tree-verify/twist-03-find-the-wrong-edge', name: 'Find the Wrong Edge', difficulty: 'Hard' },
            { id: '07-prims-algorithm/03-minimum-spanning-tree-verify/twist-04-approximate-mst-check', name: 'Approximate MST Check', difficulty: 'Medium' },
            { id: '07-prims-algorithm/03-minimum-spanning-tree-verify/twist-05-uniqueness-check', name: 'Uniqueness Check', difficulty: 'Hard' }
        ],
        similar: [

...
func main() {
    ...
    fmt.Println(PathSumToTarget(data)) // [[5 4 11 2] [5 8 4 5]]
        ...
        twists: [
            { id: '01-branch-sums/01-path-sum-to-target/twist-01-any-to-any-path-sum', name: 'Any-to-Any Path Sum', difficulty: 'Hard' },
            { id: '01-branch-sums/01-path-sum-to-target/twist-02-n-ary-tree-path-sum', name: 'N-ary Tree Path Sum', difficulty: 'Medium' },
            { id: '01-branch-sums/01-path-sum-to-target/twist-03-path-sum-count-only', name: 'Path Sum Count Only', difficulty: 'Medium' },
            { id: '01-branch-sums/01-path-sum-to-target/twist-04-iterative-path-sum-with-stack', name: 'Iterative Path Sum with Stack', difficulty: 'Medium' },
            { id: '01-branch-sums/01-path-sum-to-target/twist-05-closest-path-sum', name: 'Closest Path Sum', difficulty: 'Medium' }
        ],
        similar: [

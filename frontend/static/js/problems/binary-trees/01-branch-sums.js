...
(function() {
        ...
        examples: [
    {
        ...
        twists: [
            { id: '01-branch-sums/twist-01-n-ary-tree-branch-sums', name: 'N-ary Tree Branch Sums', difficulty: 'Medium' },
            { id: '01-branch-sums/twist-02-iterative-branch-sums', name: 'Iterative Branch Sums', difficulty: 'Medium' },
            { id: '01-branch-sums/twist-03-streaming-branch-sums', name: 'Streaming Branch Sums', difficulty: 'Hard' },
            { id: '01-branch-sums/twist-04-branch-sums-with-parent-pointers', name: 'Branch Sums with Parent Pointers', difficulty: 'Easy' },
            { id: '01-branch-sums/twist-05-count-branches-by-sum-range', name: 'Count Branches by Sum Range', difficulty: 'Medium' }
        ],
        similar: [

    ...
    const problem = {
        ...
        examples: [
            // Basic test case
            {
                ...
                output: 1,
                explanation: 'For this input, there is 1 valid position that satisfy the count distinct bst orderings criteria.'
            },
            {
                input: {"arrayOne":[10,15,8,12,94,81,5,2,11],"arrayTwo":[10,8,5,15,2,12,94,81,11]},
                output: 2,
                explanation: 'For this input, there are 2 valid positions that satisfy the count distinct bst orderings criteria.'
            },
            // Edge case
            {

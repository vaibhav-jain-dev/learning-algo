...
func main() {
    ...
    fmt.Println(CountNodesInRange(data))
        ...
        twists: [
            { id: '03-validate-bst/03-count-nodes-in-range/twist-01-count-nodes-in-range-with-augmented-bst', name: 'Count Nodes in Range with Augmented BST', difficulty: 'Hard' },
            { id: '03-validate-bst/03-count-nodes-in-range/twist-02-dynamic-range-count-with-updates', name: 'Dynamic Range Count with Updates', difficulty: 'Hard' },
            { id: '03-validate-bst/03-count-nodes-in-range/twist-03-range-count-on-multiple-non-overlapping-ranges', name: 'Range Count on Multiple Non-Overlapping Ranges', difficulty: 'Medium' },
            { id: '03-validate-bst/03-count-nodes-in-range/twist-04-kth-smallest-in-range', name: 'Kth Smallest in Range', difficulty: 'Medium' },
            { id: '03-validate-bst/03-count-nodes-in-range/twist-05-range-count-excluding-subtree', name: 'Range Count Excluding Subtree', difficulty: 'Hard' }
        ],
        similar: [

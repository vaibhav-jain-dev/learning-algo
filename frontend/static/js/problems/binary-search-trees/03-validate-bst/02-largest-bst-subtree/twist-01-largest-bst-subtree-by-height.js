    ...
    const problem = {
        ...
        examples: [
            // Basic test case
            {
                ...
                output: 3,
                explanation: 'For this input, there are 3 valid positions that satisfy the largest bst subtree by height criteria.'
            },
            {
                input: {"tree":[2,1,3]},
                output: 2,
                explanation: 'For this input, there are 2 valid positions that satisfy the largest bst subtree by height criteria.'
            },
            // Edge case
            {
                input: {"tree":[10]},

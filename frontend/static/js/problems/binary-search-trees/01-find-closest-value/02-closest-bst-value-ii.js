...
func main() {
    ...
    fmt.Println(InorderPredecessorAndSuccessor(data))
        ...
        twists: [
            { id: '01-find-closest-value/02-closest-bst-value-ii/twist-01-kth-predecessor-and-kth-successor', name: 'Kth Predecessor and Kth Successor', difficulty: 'Hard' },
            { id: '01-find-closest-value/02-closest-bst-value-ii/twist-02-predecessor-and-successor-with-node-deletion', name: 'Predecessor and Successor with Node Deletion', difficulty: 'Medium' },
            { id: '01-find-closest-value/02-closest-bst-value-ii/twist-03-predecessor-and-successor-in-threaded-bst', name: 'Predecessor and Successor in Threaded BST', difficulty: 'Hard' },
            { id: '01-find-closest-value/02-closest-bst-value-ii/twist-04-all-predecessors-and-successors-within-range', name: 'All Predecessors and Successors Within Range', difficulty: 'Medium' },
            { id: '01-find-closest-value/02-closest-bst-value-ii/twist-05-predecessor-and-successor-with-parent-pointers', name: 'Predecessor and Successor with Parent Pointers', difficulty: 'Easy' }
        ],
        similar: [

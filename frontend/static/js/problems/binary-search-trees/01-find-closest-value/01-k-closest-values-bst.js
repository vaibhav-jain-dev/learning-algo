...
func main() {
    ...
    fmt.Println(KClosestValuesInBst(data))
        ...
        twists: [
            { id: '01-find-closest-value/01-k-closest-values-bst/twist-01-k-closest-with-early-termination', name: 'K Closest with Early Termination', difficulty: 'Medium' },
            { id: '01-find-closest-value/01-k-closest-values-bst/twist-02-k-closest-using-two-bst-iterators', name: 'K Closest Using Two BST Iterators', difficulty: 'Hard' },
            { id: '01-find-closest-value/01-k-closest-values-bst/twist-03-k-closest-values-in-streaming-bst', name: 'K Closest Values in Streaming BST', difficulty: 'Hard' },
            { id: '01-find-closest-value/01-k-closest-values-bst/twist-04-k-closest-distinct-values', name: 'K Closest Distinct Values', difficulty: 'Medium' },
            { id: '01-find-closest-value/01-k-closest-values-bst/twist-05-k-closest-values-with-weighted-distance', name: 'K Closest Values with Weighted Distance', difficulty: 'Hard' }
        ],
        similar: [

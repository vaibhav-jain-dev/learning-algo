    ...
    const problem = {
        ...
        examples: [
            // Basic test case
            {
                ...
                output: 4,
                explanation: 'For this input, there are 4 valid positions that satisfy the deepest bst subtree criteria.'
            },
            {
                input: {"tree":[5,4,8,3,null,6,3]},
                output: 3,
                explanation: 'For this input, there are 3 valid positions that satisfy the deepest bst subtree criteria.'
            },
            // Edge case
            {
                input: {"tree":[1]},

    ...
    const problem = {
        ...
        examples: [
            // Basic test case
            {
                ...
                output: 1,
                explanation: 'For this input, there is 1 valid position that satisfy the sum bsts with range constraint criteria.'
            },
            {
                input: {"tree":[5,4,8,3,null,6,3]},
                output: 2,
                explanation: 'For this input, there are 2 valid positions that satisfy the sum bsts with range constraint criteria.'
            },
            // Edge case
            {
                input: {"tree":[1]},

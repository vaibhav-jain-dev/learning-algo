...
func main() {
    ...
    fmt.Println(toArray(result)) // [1 3 4 1 2 6]
        ...
        twists: [
            { id: '04-remove-kth-node/02-delete-middle-node/twist-01-delete-middle-without-slow-fast', name: 'Delete Middle Without Slow-Fast', difficulty: 'Medium' },
            { id: '04-remove-kth-node/02-delete-middle-node/twist-02-delete-both-middle-nodes', name: 'Delete Both Middle Nodes', difficulty: 'Medium' },
            { id: '04-remove-kth-node/02-delete-middle-node/twist-03-delete-middle-given-only-that-node', name: 'Delete Middle Given Only That Node', difficulty: 'Medium' },
            { id: '04-remove-kth-node/02-delete-middle-node/twist-04-move-middle-to-end', name: 'Move Middle to End', difficulty: 'Medium' },
            { id: '04-remove-kth-node/02-delete-middle-node/twist-05-delete-every-kth-middle', name: 'Delete Every Kth Middle', difficulty: 'Hard' }
        ],
        similar: [

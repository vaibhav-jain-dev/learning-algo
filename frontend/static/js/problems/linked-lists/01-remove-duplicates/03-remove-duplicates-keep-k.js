...
func main() {
    ...
    fmt.Println(toArray(result)) // [1 1 2 2 3]
        ...
        twists: [
            { id: '01-remove-duplicates/03-remove-duplicates-keep-k/twist-01-unsorted-list-keep-k', name: 'Unsorted List Keep-K', difficulty: 'Hard' },
            { id: '01-remove-duplicates/03-remove-duplicates-keep-k/twist-02-doubly-linked-sorted-list', name: 'Doubly Linked Sorted List', difficulty: 'Medium' },
            { id: '01-remove-duplicates/03-remove-duplicates-keep-k/twist-03-streaming-window-dedup', name: 'Streaming Window Dedup', difficulty: 'Hard' },
            { id: '01-remove-duplicates/03-remove-duplicates-keep-k/twist-04-reverse-thinking-keep-only-duplicates', name: 'Reverse Thinking: Keep Only Duplicates', difficulty: 'Medium' },
            { id: '01-remove-duplicates/03-remove-duplicates-keep-k/twist-05-circular-sorted-list-keep-k', name: 'Circular Sorted List Keep-K', difficulty: 'Hard' }
        ],
        similar: [

...
<div style="background: linear-gradient(135deg, #1e293b 0%, #334155 100%); border-radius: 12px; padding: 1.5rem; margin: 1.5rem 0; color: white;">
  <div style="font-weight: 700; font-size: 1.1rem; margin-bottom: 1rem; border-bottom: 1px solid #475569; padding-bottom: 0.75rem;">Summary for Interviews</div>

...
<div style="color: #a0a0a0; font-size: 13px; padding-left: 16px; border-left: 2px solid #333; margin: 12px 0;">
...
<div style="color: #a0a0a0; font-size: 13px; padding-left: 40px; border-left: 2px solid #333; margin: 12px 0 12px 24px;">
...
<div style="color: #a0a0a0; font-size: 13px; padding-left: 64px; border-left: 2px solid #333; margin: 12px 0 12px 48px;">
...
<div style="color: #a0a0a0; font-size: 11px;">Complete isolation, different DB tech per service</div>
</div>
...
<div style="color: #a0a0a0; font-size: 11px;">Logical isolation, shared infrastructure</div>
</div>
...
<div style="color: #a0a0a0; font-size: 11px;">Weak isolation, transition pattern only</div>
</div>
</div>
</div>
...
<div style="color: #a0a0a0; font-size: 13px;">Git is the single source of truth. All changes go through git. Cluster state converges to git state. Audit trail is automatic.</div>
</div>
</div>
...
<div style="color: #666; font-size: 12px;">Services are separated but still tightly coupled</div>
</div>
...
<div style="color: #666; font-size: 12px;">Multiple services accessing same database</div>
</div>
<div style="color: #a0a0a0; font-size: 13px;">
...
<div style="color: #666; font-size: 12px;">Excessive inter-service communication</div>
</div>
<div style="color: #a0a0a0; font-size: 13px;">
...
<div style="color: #666; font-size: 12px;">Can't trace requests across services</div>
</div>
<div style="color: #a0a0a0; font-size: 13px;">

...
<div style="color: #1e293b; font-size: 11px; margin-bottom: 12px;">A record of something that happened in the system</div>
...
<span style="color: #64748b;">datacontenttype, dataschema, subject, time</span>
</div>
</div>
</div>
</div>
...
<span style="color: #7ee787;">P* = Partition Leader</span> | <span style="color: #64748b;">P = Partition Replica</span>
</div>
</div>
<!-- Topic & Partitions -->
...
<div style="color: #1e293b; font-size: 11px; margin-bottom: 12px;">Instead of storing current state, store ALL state changes (events)</div>
...
<span style="color: #f85149;">Traditional:</span> <span style="color: #64748b;">State = current_values</span>
</div>
<div style="background: rgba(126,231,135,0.1); border-radius: 6px; padding: 8px;">
<span style="color: #7ee787;">Event Sourced:</span> <span style="color: #64748b;">State = fold(initial, all_events)</span>
</div>
</div>
</div>
<!-- Event Store -->
...
<div style="font-size: 10px; color: #1e293b; margin-bottom: 8px;">
...
<div style="background: rgba(59, 130, 246, 0.08); border-radius: 6px; padding: 8px; font-size: 9px; color: #64748b;">
...
<div style="color: #64748b; font-size: 10px; margin-bottom: 8px;">Version 1</div>
<div style="font-family: monospace; font-size: 9px; color: #1e293b;">

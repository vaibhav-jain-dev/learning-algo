...
{"name":"Min Cost to Connect All Points","algorithm":"kruskals-algorithm","complexity":{"time":"O(n^2 log n)","space":"O(n^2)"},"examples":[{"input":{"points":[[0,0],[2,2],[3,10],[5,2],[7,0]]},"output":20,"inputRaw":"points = [[0,0],[2,2],[3,10],[5,2],[7,0]]","outputRaw":"20"}]}
</div>

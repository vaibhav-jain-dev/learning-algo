...
{"name":"Binary Tree Maximum Path Sum","algorithm":"tree-max-path","complexity":{"time":"O(n)","space":"O(h)"},"examples":[{"input":{"tree":{"value":1,"left":{"value":2},"right":{"value":3}}},"output":6,"inputRaw":"tree = {1,2,3}","outputRaw":"6 (path: 2 -> 1 -> 3)"},{"input":{"tree":{"value":-10,"left":{"value":9},"right":{"value":20,"left":{"value":15},"right":{"value":7}}}},"output":42,"inputRaw":"tree = {-10,9,20,#,#,15,7}","outputRaw":"42 (path: 15 -> 20 -> 7)"}]}
</div>

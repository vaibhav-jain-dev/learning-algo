...
func (h *Handlers) buildSmartRoadmap() []models.DayPlan {
	return []models.DayPlan{
		{
			Day:   1,
			Title: "Foundation Day - Arrays, Strings & System Design Basics",
			Sessions: []models.StudySession{
				{
					Time:        "09:00 - 12:00",
					Duration:    "3 hours",
					Topic:       "Arrays & Strings Problems",
					Description: "Master array manipulation, two pointers, sliding window techniques",
					Link:        "/200-problems",
					Icon:        "📊",
					Category:    "DSA",
				},
				{
					...
					Description: "Understand distributed system fundamentals and caching strategies",
					Link:        "/system-design",
					Icon:        "🏗️",
				...
				},
				{
					Time:        "14:00 - 16:00",
					Duration:    "2 hours",
					Topic:       "Singleton, Factory & Strategy Patterns",
					Description: "Learn creational and behavioral design patterns",
				...
				},
				{
					Time:        "16:00 - 18:00",
					Duration:    "2 hours",
					Topic:       "Build LRU Cache",
					Description: "Implement a least recently used cache from scratch",
					Link:        "/machine-coding",
					Icon:        "⚙️",
				...
				},
				{
					...
					Description: "Revise concepts and solve additional problems",
					Link:        "/practice",
					Icon:        "🔄",
					Category:    "Review",
				},
		...
		{
			Day:   2,
			Title: "Trees & Graphs - Data Structures Deep Dive",
			Sessions: []models.StudySession{
				{
					Time:        "09:00 - 12:00",
					Duration:    "3 hours",
					Topic:       "Binary Trees & BST Problems",
					Description: "Master tree traversals, recursion, and binary search trees",
					Link:        "/200-problems",
					Icon:        "🌳",
					Category:    "DSA",
				},
				{
					Time:        "12:00 - 14:00",
					Duration:    "2 hours",
					Topic:       "Database Replication & CAP Theorem",
					Description: "Learn consistency, availability, and partition tolerance trade-offs",
					Link:        "/system-design",
					Icon:        "💾",
					Category:    "System Design",
				},
				{
					Time:        "14:00 - 16:00",
					Duration:    "2 hours",
					Topic:       "Observer, Decorator & Adapter Patterns",
					Description: "Understand structural and behavioral patterns",
					Link:        "/design-patterns",
					Icon:        "🎨",
					Category:    "Design Patterns",
				},
				{
					...
					Description: "Master joins, aggregations, and query optimization",
					Link:        "/sql",
					Icon:        "🗄️",
					Category:    "Database",
				},
				{
					Time:        "18:00 - 19:00",
					Duration:    "1 hour",
					Topic:       "Practice SQL Queries",
					Description: "Solve real-world SQL problems",
					Link:        "/sql",
					Icon:        "🔄",
					Category:    "Review",
				},
			...
			Sessions: []models.StudySession{
				{
					...
					Description: "Master DP patterns: memoization, tabulation, and optimization",
					Link:        "/200-problems",
					Icon:        "🎯",
					Category:    "DSA",
				},
				{
					Time:        "12:00 - 14:00",
					Duration:    "2 hours",
					Topic:       "Microservices & Service Discovery",
					Description: "Learn microservices architecture and communication patterns",
					Link:        "/microservices",
					Icon:        "📦",
				...
				},
				{
					Time:        "14:00 - 16:00",
					Duration:    "2 hours",
					Topic:       "Builder, Prototype & Chain of Responsibility",
					Description: "Advanced creational and behavioral patterns",
					Link:        "/design-patterns",
					Icon:        "🔗",
					Category:    "Design Patterns",
				},
				{
					...
					Description: "Master Redis data structures and caching strategies",
					Link:        "/redis",
					Icon:        "⚡",
					Category:    "Cache",
				},
				{
					Time:        "18:00 - 19:00",
					Duration:    "1 hour",
					Topic:       "Redis Hands-on",
					Description: "Practice Redis commands and patterns",
					Link:        "/redis",
					Icon:        "🔄",
					Category:    "Review",
				},
		...
		{
			Day:   4,
			Title: "Graphs & System Architectures",
			Sessions: []models.StudySession{
				{
					Time:        "09:00 - 12:00",
					Duration:    "3 hours",
					Topic:       "Graph Algorithms",
					Description: "Master BFS, DFS, shortest paths, and topological sort",
					Link:        "/200-problems",
					Icon:        "🕸️",
					Category:    "DSA",
				},
				{
					Time:        "12:00 - 14:00",
					Duration:    "2 hours",
					Topic:       "Netflix, Uber & Twitter Architectures",
					Description: "Study real-world system architectures and scalability patterns",
				...
				},
				{
					Time:        "14:00 - 16:00",
					Duration:    "2 hours",
					Topic:       "Command, Iterator & Mediator Patterns",
					Description: "Learn behavioral design patterns for complex systems",
					Link:        "/design-patterns",
					Icon:        "🎭",
					Category:    "Design Patterns",
				},
				{
					Time:        "16:00 - 18:00",
					Duration:    "2 hours",
					Topic:       "Elasticsearch & Full-Text Search",
					Description: "Master search queries, mappings, and analyzers",
					Link:        "/elasticsearch",
					Icon:        "🔍",
					Category:    "Search",
				},
				{
					Time:        "18:00 - 19:00",
					Duration:    "1 hour",
					Topic:       "Search Queries Practice",
					Description: "Build complex search queries",
					Link:        "/elasticsearch",
					Icon:        "🔄",
					Category:    "Review",
				},
		...
		{
			Day:   5,
			Title: "Advanced Algorithms & Rate Limiting",
			Sessions: []models.StudySession{
				{
					Time:        "09:00 - 12:00",
					Duration:    "3 hours",
					Topic:       "Sorting, Searching & Heaps",
					Description: "Master advanced sorting algorithms and heap operations",
					Link:        "/200-problems",
					Icon:        "📈",
					Category:    "DSA",
				},
				{
					Time:        "12:00 - 14:00",
					Duration:    "2 hours",
					Topic:       "Rate Limiting & Circuit Breaker",
					Description: "Learn system reliability and fault tolerance patterns",
					Link:        "/system-design",
					Icon:        "🚦",
					Category:    "System Design",
				},
				{
					Time:        "14:00 - 16:00",
					Duration:    "2 hours",
					Topic:       "Proxy, Facade & Flyweight Patterns",
					Description: "Master structural patterns for performance optimization",
					Link:        "/design-patterns",
					Icon:        "🎪",
					Category:    "Design Patterns",
				},
				...
				},
				{
					Time:        "18:00 - 19:00",
					Duration:    "1 hour",
					Topic:       "Rate Limiting Practice",
					Description: "Test different rate limiting strategies",
					Link:        "/practice",
					Icon:        "🔄",
					Category:    "Review",
				},
			...
			Sessions: []models.StudySession{
				{
					Time:        "09:00 - 12:00",
					Duration:    "3 hours",
					Topic:       "Concurrency & Multithreading Problems",
					Description: "Master locks, semaphores, and concurrent data structures",
					Link:        "/200-problems",
					Icon:        "🔀",
					Category:    "DSA",
				},
				{
					Time:        "12:00 - 14:00",
					Duration:    "2 hours",
					Topic:       "Distributed Locking & Consensus",
					Description: "Learn Paxos, Raft, and distributed coordination",
					Link:        "/system-design",
					Icon:        "🔐",
					Category:    "System Design",
				},
				{
					Time:        "14:00 - 16:00",
					Duration:    "2 hours",
					Topic:       "State, Template Method & Visitor Patterns",
					Description: "Advanced behavioral patterns for state management",
					Link:        "/design-patterns",
					Icon:        "🎬",
					Category:    "Design Patterns",
				},
				{
					Time:        "16:00 - 18:00",
					Duration:    "2 hours",
					Topic:       "Golang Concurrency Patterns",
					Description: "Master goroutines, channels, and concurrency patterns",
					Link:        "/golang",
					Icon:        "🐹",
					Category:    "Language",
				},
				{
					...
					Description: "Build concurrent programs in Go",
					Link:        "/golang",
					Icon:        "🔄",
					Category:    "Review",
				},
			...
			Sessions: []models.StudySession{
				{
					Time:        "09:00 - 12:00",
					Duration:    "3 hours",
					Topic:       "Mixed Algorithm Problems",
					Description: "Solve problems from all categories - simulate interview conditions",
					Link:        "/200-problems",
					Icon:        "🎓",
					Category:    "DSA",
				},
				{
					Time:        "12:00 - 14:00",
					Duration:    "2 hours",
					Topic:       "Design Twitter, WhatsApp & YouTube",
					Description: "End-to-end system design practice with real systems",
					Link:        "/system-design",
					Icon:        "🎯",
					Category:    "System Design",
				},
				{
					Time:        "14:00 - 16:00",
					Duration:    "2 hours",
					Topic:       "Design Patterns & Microservices Review",
					Description: "Revise all patterns and microservices concepts",
					Link:        "/design-patterns",
					Icon:        "📚",
					Category:    "Review",
				},
				{
					Time:        "16:00 - 18:00",
					Duration:    "2 hours",
					Topic:       "Python Asyncio & Event Loops",
				...
				},
				{
					Time:        "18:00 - 19:00",
					Duration:    "1 hour",
					Topic:       "Final Review & Next Steps",
					Description: "Review weak areas and plan for continued learning",
					Link:        "/",
					Icon:        "✅",
					Category:    "Complete",
				},
